...
- **视觉高**：**直立/中性帧=256 硬门**，不给 ±10% 放宽；**宽/腾空/横躺动作帧不设身高门**，改判「贴合画布（宽 ≤236）+ 人物尺度与基准帧一致（头脸宽度 ±10%）」——**09-10 Leo 裁**：240 宽画布下宽腾空姿势物理上无法同时满足 256 高与宽上限（宽高比 >236/256=0.92，如实测帧 0.99）；与 die 横躺帧「宽 ≤220」条款同构
