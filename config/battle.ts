...
export const FOOT_DROP = 0.2; // L 环五轮b：Leo 复验 0.25 过冲，上提 0.05
...
export const BATTLE_FRAME = {
  idle: 3, // Q3-T06 回退：d2⑧帧素材风格跑偏（深色墨影，与白衣主角不符——见素材回报单），待重出后切回 7；江湖 idle 仍 00
  walkStart: 1,
  walkEnd: 3,
  charge: 4, // 出招预备（蓄力段）
  strike: 5, // 出招挥出
