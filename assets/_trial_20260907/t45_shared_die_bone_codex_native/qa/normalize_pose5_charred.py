...
SRC = ROOT / "raw" / "die_common_bone_pose5_charred_attempt1.png"
OUT = ROOT / "normalized" / "die_common_bone_pose5_charred.png"
DARK = ROOT / "contact" / "die_common_bone_pose5_charred_dark_check.png"
QA = ROOT / "qa" / "die_common_bone_pose5_charred.json"
...
def main() -> None:
    ...
    record = {
        "key": "die_common_bone_pose5_charred",
