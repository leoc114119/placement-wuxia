...
SRC = ROOT / "raw" / "die_common_bone_pose6_gag_white_attempt1.png"
OUT = ROOT / "normalized" / "die_common_bone_pose6_gag_white.png"
DARK = ROOT / "contact" / "die_common_bone_pose6_gag_white_dark_check.png"
QA = ROOT / "qa" / "die_common_bone_pose6_gag_white.json"
...
def main() -> None:
    ...
    record = {
        "key": "die_common_bone_pose6_gag_white",
