#!/usr/bin/env python3
"""Normalize the selected shared die-bone pose without redrawing it.
...
SRC = ROOT / "raw" / "die_common_bone_pose2_shadow_attempt1.png"
OUT = ROOT / "normalized" / "die_common_bone_pose2_shadow.png"
DARK = ROOT / "contact" / "die_common_bone_pose2_shadow_dark_check.png"
QA = ROOT / "qa" / "die_common_bone_pose2_shadow.json"
...
def main() -> None:
    ...
    record = {
        "key": "die_common_bone_pose2_shadow",
