...
SPECS = {
    "shanzei_a": {
        "raw": "raw/shanzei_a_atk_right_2_upright_fist_forward_inward_attempt1.png",
        "normalized": "normalized/shanzei_a_atk_right_2_upright_fist_forward_inward.png",
    ...
    "shanzei_b": {
        "raw": "raw/shanzei_b_atk_right_2_upright_fist_forward_inward_attempt1.png",
        "normalized": "normalized/shanzei_b_atk_right_2_upright_fist_forward_inward.png",
...
def make_contact(rows, out: Path):
    ...
    for i,(ident,spec,cand) in enumerate(rows):
        ...
        d.text((panel_w+4,y+4), f"{spec['label']} · FORWARD-INWARD UPRIGHT FIST V2", fill=(18,18,18,255))
    sheet.save(out)
...
def main():
    rows=[]; qa={"task":"T45","scope":"forward-inward bent upright right punching fist pilot v2","status":"candidate_pending_leo_visual","frames":{}}
    ...
    manifest={"task":"T45","revision":"upright-fist-forward-inward-v2","generatedAt":"2026-09-08","trialOnly":True,"scope":"shanzei_a|b × atk_right_2 (right)","decision":"A: all 24 NPC attack body frames eventually use upright closed punching fist; this is the 2-frame forward-inward bend pilot revision","generation":{"provider":"Codex native ImageGen","model":None,"credits":0,"rawImageGeneration":True},"processing":{"cutout":"project flood_cut + feather","normalize":"240x320 RGBA, visualHeight=256, feetY=300, alpha32 centroid x≈120", "poseAdjustment":"extended right fist slightly forward and inward toward character centerline; no weapon"},"visualReview":"pending_Leo","specGate":"pending_pm_scan","integrationGate":"not_handed_off","runtimeRelease":False,"formalRuntimeTouched":False,"supersedesCandidate":"assets/_trial_20260908/t45_npc_upright_fist_pilot_codex_native/","artifactPaths":[]}
