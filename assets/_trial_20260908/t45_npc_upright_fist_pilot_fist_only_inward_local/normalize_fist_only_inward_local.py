...
SPECS = {
    "shanzei_a": {
        "raw": "raw/shanzei_a_atk_right_2_fist_only_inward_attempt1.png",
        "normalized": "normalized/shanzei_a_atk_right_2_fist_only_inward.png",
        "source": "assets/_trial_20260908/t45_npc_upright_fist_pilot_fist_only_local/normalized/shanzei_a_atk_right_2_fist_only_forward_inward.png",
        "sourceSha256": "569e83fcaad926a775f73c865c4b00217dcb3e753b9b2e1b3e7cf24152cb2404",
        "identity": "assets/_trial_20260906/t45_batch2a_a_right_singleframe_v1_codex_native/normalized/shanzei_a_right.png",
        "label": "shanzei_a / atk_right_2 (prior local)",
    },
    "shanzei_b": {
        "raw": "raw/shanzei_b_atk_right_2_fist_only_inward_attempt1.png",
        "normalized": "normalized/shanzei_b_atk_right_2_fist_only_inward.png",
        "source": "assets/_trial_20260908/t45_npc_upright_fist_pilot_fist_only_local/normalized/shanzei_b_atk_right_2_fist_only_forward_inward.png",
        "sourceSha256": "436f7579ca664a9d4612494e1e514be506df8d2c839e7f4ba5400224e841ed3e",
        "identity": "assets/_trial_20260906/t45_batch2a_bright_v8_two_ref_hero_height_codex_native/normalized/shanzei_b_right.png",
        "label": "shanzei_b / atk_right_2 (prior local)",
    },
}
...
def make_contact(rows, out: Path):
    ...
    for i,(ident,spec,cand) in enumerate(rows):
        ...
        d.text((panel_w+4,y+4), f"{spec['label']} · FIST-ONLY INWARD-TILT CANDIDATE", fill=(18,18,18,255))
    sheet.save(out)
...
def main():
    rows=[]; qa={"task":"T45","scope":"fist-only inward-tilt local visual candidate","status":"candidate_pending_leo_visual","frames":{}}
    ...
    manifest={"task":"T45","revision":"fist-only-inward-tilt-local","generatedAt":"2026-09-08","trialOnly":True,"scope":"shanzei_a|b × atk_right_2 (right)","decision":"Local visual candidate: only distal fist adjusted with slight inward tilt; arm remains frozen","generation":{"provider":"Codex native ImageGen","model":None,"credits":0,"rawImageGeneration":True},"processing":{"cutout":"project flood_cut + feather","normalize":"240x320 RGBA, visualHeight=256, feetY=300, alpha32 centroid x≈120", "poseAdjustment":"fist only; slight inward tilt; forearm/elbow/upper arm frozen"},"visualReview":"pending_Leo","specGate":"pending_pm_scan","integrationGate":"not_handed_off","runtimeRelease":False,"formalRuntimeTouched":False,"localOnly":True,"artifactPaths":[]}
