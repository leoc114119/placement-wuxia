...
BODY_SOURCE=BODY
BODY=REV/'body/battle_idle_rightdown_fist_out_v5.png'
SOURCE=ROOT/'assets/_trial_20260908/t45_hero_weapon_pilot_frame01_codex_native/normalized/hero_sword_held_rightdown.png'
RAW=REV/'raw/hero_sword_source_rightdown_v1.png'; OUT=REV/'normalized/hero_sword_held_idle_rightdown_character_right_hand_v5.png'; MASK=REV/'occlusion_masks/hero_idle_rightdown_screen_left_fist_v5.png'; TRIP=REV/'composites_native/hero_idle_rightdown_sword_character_right_hand_triptych_v5.png'; TRIP2=REV/'composites_2x/hero_idle_rightdown_sword_character_right_hand_triptych_v5_2x.png'; CONTACT=REV/'contact/hero_idle_rightdown_sword_character_right_hand_v5.png'; ZOOM=REV/'contact/idle_rightdown_character_right_fist_center_zoom_v5.png'; QA=REV/'qa/pilot_idle_rightdown_character_right_hand_v5.json'; CAL=REV/'calibration/frame06_idle_rightdown_character_right_hand_v5.json'
W,H=240,320
TX,TY=38,0
...
def main():
 ...
 src=Image.open(SOURCE).convert('RGBA');RAW.write_bytes(SOURCE.read_bytes());src=src.transpose(Image.Transpose.FLIP_LEFT_RIGHT);src=src.rotate(-151.37742658748023,resample=Image.Resampling.NEAREST,expand=False,center=(64,195));weapon=translate(src,TX,TY);weapon.save(OUT)
 ...
 ct=Image.new('RGBA',(W*3,H+42),(236,236,236,255));ct.alpha_composite(tri,(0,42));d=ImageDraw.Draw(ct);d.text((4,4),'WEAPON FRONT + precise fist overlay · character RIGHT hand (screen-left fist)',fill=(20,20,20,255));d.text((4,22),f'idle_rightdown · handle≈({TARGET_HANDLE[0]:.2f},{TARGET_HANDLE[1]:.2f}) · mirrored+face15 rightdown v5 + ({TX},{TY}) · angle=-75.000°',fill=(20,20,20,255));ct.save(CONTACT);ct.resize((ct.width*2,ct.height*2),Image.Resampling.NEAREST).save(REV/'contact/hero_idle_rightdown_sword_character_right_hand_v5_2x.png')
