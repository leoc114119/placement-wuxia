...
set -e
GLB="$HOME/Downloads/chibi+character+3d+model (1).glb"
TEX="assets/_trial_20260912/model_v3/tex/basecolor.raw"
TW=4096; TH=4096
DIR="assets/_trial_20260912/glb2d_idle"
ANIM_JSON="$DIR/retarget_idle_v3.json"
OUT="$DIR/idle_6dir_v3"
...
for entry in "${DIRS[@]}"; do
  ...
  for sf in "${SRC_FRAMES[@]}"; do
    ...
    python3 "$TOOLS/tone_pass.py" /tmp/_iv1.raw /tmp/_iv1t.raw 240 320 --contrast 1.5 --saturation 1.25 --brightness 22 >/dev/null
