...
OUT=REV/'normalized/hero_sword_angle_minus45_cast_rightdown_1_v6.png'; MASK=REV/'occlusion_masks/right_fist_precise_v6.png'; REVEAL=REV/'occlusion_masks/grip_only_v6.png'; CONTACT=REV/'contact/hero_cast_rightdown_1_mask_fixed_v6.png'; CONTACT2=REV/'contact/hero_cast_rightdown_1_mask_fixed_v6_2x.png'; QA=REV/'qa/pilot_cast_rightdown_1_mask_fixed_v6.json'; CAL=REV/'calibration/frame20_cast_rightdown_1_mask_fixed_v6.json'; MANIFEST=REV/'manifest.json'; JOB=REV/'job.json'
W,H=240,320; sh=(101.57368615160715,205.58781573590227); handle=(94.57368615160715,118.58781573590227); fist=(94,123)
...
body=Image.open(BODY).convert('RGBA'); src=Image.open(SOURCE).convert('RGBA'); rot=src.rotate(5,resample=Image.Resampling.BICUBIC,center=sh); weapon=Image.new('RGBA',(W,H),(0,0,0,0)); weapon.alpha_composite(rot,(-8,-87)); weapon.save(OUT)
...
common={'task':'T45','revision':'frame20-cast-rightdown-1-original-body-angle45-up4-mask-fixed-v6','artifactStage':'candidate','visualReview':'pending_Leo','specGate':'pending_pm_scan','integrationGate':'not_handed_off','runtimeRelease':False,'status':'candidate_only'}
