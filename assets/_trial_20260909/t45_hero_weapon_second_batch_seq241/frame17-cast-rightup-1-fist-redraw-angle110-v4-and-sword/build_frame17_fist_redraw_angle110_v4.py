...
BODY=ROOT/'assets/characters/hero/battle45/cast_rightup_1.png'; GEN=Path('/Users/leochen/.codex/generated_images/01a06f37-6f31-77a3-a9e0-cd919de56beb/exec-6af22157-b774-4c70-8f9e-92148ca249f9.png'); SOURCE=ROOT/'assets/_trial_20260908/t45_hero_weapon_pilot_frame01_codex_native/revisions/handle-center-half-length-v9/normalized/hero_sword_held_rightup_v9.png'
RAW=REV/'raw/generated_fist_redraw_full_edit.png'; BODYOUT=REV/'normalized/cast_rightup_1_fist_redrawn_body_candidate.png'; OUT=REV/'normalized/hero_sword_angle_minus110_cast_rightup_1_fist_redrawn_angle110_v4.png'; MASK=REV/'occlusion_masks/cast_rightup_1_redrawn_right_fist_angle110_v4.png'; REVEAL=REV/'occlusion_masks/cast_rightup_1_redrawn_fist_handle_reveal_angle110_v4.png'; CONTACT=REV/'contact/hero_cast_rightup_1_fist_redrawn_angle110_sword_v4.png'; CONTACT2=REV/'contact/hero_cast_rightup_1_fist_redrawn_angle110_sword_v4_2x.png'; ZOOM=REV/'contact/cast_rightup_1_fist_redrawn_angle110_sword_zoom_v4.png'; QA=REV/'qa/pilot_cast_rightup_1_fist_redrawn_angle110_sword_v4.json'; CAL=REV/'calibration/frame17_cast_rightup_1_fist_redrawn_angle110_sword_v4.json'; MANIFEST=REV/'manifest.json'; JOB=REV/'job.json'; REFS=REV/'refs.json'; PROMPT=REV/'prompts/fist_redraw_angle110_v4.txt'
SOURCE_HANDLE=(101.57368615160715,205.58781573590227); FIST=(183.0,95.0); HANDLE=(183.57368615160715,94.58781573590227); ROTATE_DEG=70.0; SHIFT=(82,-111)
