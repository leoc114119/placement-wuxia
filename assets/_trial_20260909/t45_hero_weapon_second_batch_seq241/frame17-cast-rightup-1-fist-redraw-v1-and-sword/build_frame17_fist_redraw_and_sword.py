...
BODY=ROOT/'assets/characters/hero/battle45/cast_rightup_1.png'; GEN=Path('/Users/leochen/.codex/generated_images/01a06f37-6f31-77a3-a9e0-cd919de56beb/exec-c328fad3-2363-419e-a66e-aa7ea916920f.png'); SOURCE=ROOT/'assets/_trial_20260908/t45_hero_weapon_pilot_frame01_codex_native/revisions/handle-center-half-length-v9/normalized/hero_sword_held_rightup_v9.png'
RAW=REV/'raw/generated_fist_redraw_full_edit.png'; BODYOUT=REV/'normalized/cast_rightup_1_fist_redrawn_body_candidate.png'; OUT=REV/'normalized/hero_sword_angle_minus90_cast_rightup_1_fist_redrawn_v1.png'; MASK=REV/'occlusion_masks/cast_rightup_1_redrawn_right_fist_v1.png'; REVEAL=REV/'occlusion_masks/cast_rightup_1_redrawn_fist_handle_reveal_v1.png'; CONTACT=REV/'contact/hero_cast_rightup_1_fist_redrawn_sword_minus90_v1.png'; CONTACT2=REV/'contact/hero_cast_rightup_1_fist_redrawn_sword_minus90_v1_2x.png'; ZOOM=REV/'contact/cast_rightup_1_fist_redrawn_sword_zoom_v1.png'; QA=REV/'qa/pilot_cast_rightup_1_fist_redrawn_sword_v1.json'; CAL=REV/'calibration/frame17_cast_rightup_1_fist_redrawn_sword_v1.json'; MANIFEST=REV/'manifest.json'; JOB=REV/'job.json'; REFS=REV/'refs.json'; PROMPT=REV/'prompts/fist_redraw_v1.txt'
...
def main():
 ...
 common={'task':'T45','revision':'frame17-cast-rightup-1-fist-redraw-v1-and-sword','artifactStage':'candidate','visualReview':'pending_Leo','specGate':'pending_pm_scan','integrationGate':'not_handed_off','runtimeRelease':False,'status':'candidate_only'}
