...
RAW=REV/'raw/hero_sword_angle_0_v4.png'; OUT=REV/'normalized/hero_sword_angle_0_cast_right_3_v5_handle_visible.png'; MASK=REV/'occlusion_masks/cast_right_3_screen_left_lowered_fist_v5.png'; REVEAL=REV/'occlusion_masks/cast_right_3_handle_reveal_v5.png'; CONTACT=REV/'contact/hero_cast_right_3_sword_angle_0_v5_handle_visible.png'; CONTACT2=REV/'contact/hero_cast_right_3_sword_angle_0_v5_handle_visible_2x.png'; ZOOM=REV/'contact/cast_right_3_handle_visible_zoom_v5.png'; QA=REV/'qa/pilot_cast_right_3_angle_0_v5_handle_visible.json'; CAL=REV/'calibration/frame16_cast_right_3_angle_0_v5_handle_visible.json'; MANIFEST=REV/'manifest.json'; JOB=REV/'job.json'; REFS=REV/'refs.json'
...
def main():
 ...
 reveal=Image.new('L',(W,H),0); ImageDraw.Draw(reveal).polygon([(72,217),(101,217),(107,231),(72,231)],fill=255); reveal.save(REVEAL)
 ...
 common={'task':'T45','revision':'frame16-cast-right-3-sword-character-right-hand-v5-handle-visible','artifactStage':'candidate','visualReview':'pending_Leo','specGate':'pending_pm_scan','integrationGate':'not_handed_off','runtimeRelease':False,'status':'candidate_only'}
