...
OUT=REV/'normalized/hero_sword_angle_minus45_cast_rightdown_2_v3.png'; MASK=REV/'occlusion_masks/right_fist_precise_v3.png'; REVEAL=REV/'occlusion_masks/grip_only_v3.png'; CONTACT=REV/'contact/hero_cast_rightdown_2_mask_fixed_v3.png'; CONTACT2=REV/'contact/hero_cast_rightdown_2_mask_fixed_v3_2x.png'; QA=REV/'qa/pilot_cast_rightdown_2_mask_fixed_v3.json'; CAL=REV/'calibration/frame21_cast_rightdown_2_mask_fixed_v3.json'; MANIFEST=REV/'manifest.json'; JOB=REV/'job.json'
W,H=240,320; sh=(101.57368615160715,205.58781573590227); handle=(126.57368615160715,169.58781573590227); fist=(126,170)
...
body=Image.open(BODY).convert('RGBA'); src=Image.open(SOURCE).convert('RGBA'); rot=src.rotate(5,resample=Image.Resampling.BICUBIC,center=sh); weapon=Image.new('RGBA',(W,H),(0,0,0,0)); weapon.alpha_composite(rot,(25,-36)); weapon.save(OUT)
...
common={'task':'T45','revision':'frame21-cast-rightdown-2-original-body-lower-right-hand-v3','artifactStage':'candidate','visualReview':'pending_Leo','specGate':'pending_pm_scan','integrationGate':'not_handed_off','runtimeRelease':False,'status':'candidate_only'}
