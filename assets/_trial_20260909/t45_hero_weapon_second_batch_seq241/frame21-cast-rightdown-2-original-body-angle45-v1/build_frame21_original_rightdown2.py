...
OUT=REV/'normalized/hero_sword_angle_minus45_cast_rightdown_2_v1.png'; MASK=REV/'occlusion_masks/right_fist_precise_v1.png'; REVEAL=REV/'occlusion_masks/grip_only_v1.png'; CONTACT=REV/'contact/hero_cast_rightdown_2_mask_fixed_v1.png'; CONTACT2=REV/'contact/hero_cast_rightdown_2_mask_fixed_v1_2x.png'; QA=REV/'qa/pilot_cast_rightdown_2_mask_fixed_v1.json'; CAL=REV/'calibration/frame21_cast_rightdown_2_mask_fixed_v1.json'; MANIFEST=REV/'manifest.json'; JOB=REV/'job.json'
...
common={'task':'T45','revision':'frame21-cast-rightdown-2-original-body-angle45-v1','artifactStage':'candidate','visualReview':'pending_Leo','specGate':'pending_pm_scan','integrationGate':'not_handed_off','runtimeRelease':False,'status':'candidate_only'}
